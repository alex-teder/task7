...
Command: npx gltfjsx@6.2.15 public/models/Bull.glb -o src/components/Bull.jsx -r public 
*/
...
export function Bull(props) {
  const { group, materials, nodes, position } = useAnimal("Bull", props);
